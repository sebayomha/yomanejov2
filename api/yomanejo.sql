...
INSERT INTO `clase` (`idClase`, `alumno`, `auto`, `fecha`, `horaInicio`, `idZona`, `idDireccion`, `idCronograma`, `status`, `sumada`, `nroClase`, `claseCancelada`, `motivoCancelacion`, `fechaClaseCancelada`, `fechaClaseReactivada`) VALUES
