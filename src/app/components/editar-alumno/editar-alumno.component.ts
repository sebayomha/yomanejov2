...
export class EditarAlumnoComponent implements OnInit {
  ...
  setInformationOnInit() {
    ...
    Object.values(this.alumnoInformation.disponibilidades).forEach((disponibilidad: any, index) => {
      if (disponibilidad.todoElDia) {
        ...
        let option = new Option(
          ...
          [],
          this.predefinedHours,
          disponibilidad.usandoDirAlternativa
        );
        let options = new Array(option);
        let dateTime = new DatesTimes(this.showNameDay(index), true, options);
        dates_times.push(dateTime);
      } else {
        //es por tramos o el dia no puede
        if (!disponibilidad.todoElDia && disponibilidad.tramosHorarios.length) {
          //es por tramos
    ...
    let street = new Address(
      this.alumnoInformation.calle_DirPrincipal,
      this.alumnoInformation.calle_diag_DirPrincipal == 'true'
    );
    let street_a = new Address(
      '',
      this.alumnoInformation.calle_a_diag_DirPrincipal == 'true',
      this.alumnoInformation.calle_a_DirPrincipal
    );
    let street_b = new Address(
      undefined,
      this.alumnoInformation.calle_b_diag_DirPrincipal == 'true',
      '',
      this.alumnoInformation.calle_b_DirPrincipal
    );
    let altitud = new Address(undefined, false, undefined, undefined, this.alumnoInformation.numero_DirPrincipal);
    let city = new Address(
      undefined,
      false,
      undefined,
      undefined,
      undefined,
      this.alumnoInformation.ciudad_DirPrincipal
    );
    let floor = new Address(
      undefined,
      false,
      undefined,
      undefined,
      undefined,
      '',
      this.alumnoInformation.floor_DirPrincipal
    );
    let department = new Address(
      undefined,
      false,
      undefined,
      undefined,
      ...
      '',
      '',
      this.alumnoInformation.departamento_DirPrincipal
    );
    let obser = new Address(
      undefined,
      false,
      undefined,
      undefined,
      ...
      '',
      '',
      this.alumnoInformation.observaciones_DirPrincipal
    );
    ...
    if (this.alumnoInformation.id_DirAlternativa != null) {
      ...
      //direccion principal del cronograma
      let street_alt = new Address(
        this.alumnoInformation.calle_DirAlternativa,
        this.alumnoInformation.calle_diag_DirAlternativa == 'true'
      );
      let street_a_alt = new Address(
        '',
        this.alumnoInformation.calle_a_diag_DirAlternativa == 'true',
        this.alumnoInformation.calle_a_DirAlternativa
      );
      let street_b_alt = new Address(
        undefined,
        this.alumnoInformation.calle_b_diag_DirAlternativa == 'true',
        '',
        this.alumnoInformation.calle_b_DirAlternativa
      );
      let altitud_alt = new Address(
        undefined,
        false,
        undefined,
        undefined,
        this.alumnoInformation.numero_DirAlternativa
      );
      let city_alt = new Address(
        undefined,
        false,
        undefined,
        undefined,
        undefined,
        this.alumnoInformation.ciudad_DirAlternativa
      );
      let floor_alt = new Address(
        undefined,
        false,
        undefined,
        undefined,
        undefined,
        '',
        this.alumnoInformation.floor_DirAlternativa
      );
      let department_alt = new Address(
        undefined,
        false,
        undefined,
        undefined,
        ...
        '',
        '',
        this.alumnoInformation.departamento_DirAlternativa
      );
      let obser_alt = new Address(
        undefined,
        false,
        undefined,
        undefined,
        ...
        '',
        '',
        this.alumnoInformation.observaciones_DirAlternativa
      );
      ...
      //no posee direccion alternativa asi que seteamos todo vacio
    ...
    this.search = new Search(
      this.alumnoInformation.nombre,
      dates_times,
      this.addresses,
      this.addresses_alt,
      this.alumnoInformation.cantClasesParaRestantes,
      new Date(),
      this.alumnoInformation.telefono
    );
    ...
    if (!this.modificoDatosPersonales()) {
      ...
      if (this.soloDatosPersonalesSinDireccion) {
        ...
        if (this.editingStudentForm.valid && this.direccionFisica.validateForm()) {
          ...
          //mostrar errores en la direccion
  ...
  modificoDatosPersonales() {
    ...
    if (
      this.alumnoInformation.telefono.replace(/\s/g, '').replace('-', '') ==
        this.search.student_phone.toString().replace(/\s/g, '').replace('-', '') &&
      this.alumnoInformation.documento == this.documento &&
      this.alumnoInformation.nombre == this.search.student_name
    ) {
      if (direccionFisicaInformation.nuevaDireccion) {
        //estamos sobre nueva direccion
        //datos primarios personales continuan iguales, evaluo si la direccion fisica cambio.
        if (
          this.alumnoInformation.calle_DirFisica == direccionFisicaInformation.direccion.street &&
          ...
          //modifico datos personales de la direccion fisica
          this.soloDatosPersonalesSinDireccion = false;
          return true;
        }
      } else {
        //es una direccion que ya existe entonces tengo que comparar los ids
        if (direccionFisicaInformation.idDireccionSeleccionada == this.alumnoInformation.id_DirFisica) {
          //es la misma
          return false;
        } else {
          this.soloDatosPersonalesSinDireccion = false;
